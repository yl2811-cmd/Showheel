...
(() => {
 ...
 function syncInterface(){
  ...
  $('geography-sidebar').hidden=cosmic;$('astronomy-sidebar').hidden=!cosmic;$('space-back').hidden=!cosmic;$('space-breadcrumbs').hidden=!cosmic;$('space-instructions').hidden=!cosmic;$('local-tabs').hidden=activeTab!=='local';
 ...
 function showObject(value){
  ...
  if(o.id==='archeon')html+='<p class="source">当地 Year 521 的世界与 Federation 当时掌握的资料分开呈现；不表示已经重新建立联系。</p>';
 ...
 Object.assign(app,{setTab,setEpoch,focusObject,setExposure,setBrightness,enterColonySystem,returnToFederation,getSpaceState:()=>instance?.getState()||null,spaceSearch:q=>instance?.search(q)||[],currentTab:activeTab,epoch,localView});
